...
def visualize_photon_count(*Xs, filename=None):
    """
...
def visualize_cumulative_arrival_distribution(*Xs, filename=None):
    """
...
def visualize_individual_arrival_distribution(X, limit, filename=None):
    """
